                ...
                <div id="perfil">
                    ...
                    <div class="user-data">
                        <form action="" method="post">
                            <a href="#" class="btn-system btn-primary width-cem text-center">Abrir QR Code</a>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="input-fullname" class="form-label">ID do Senac</label>
                                <input type="text" class="form-control" id="input-fullname" name="input-fullname"
                                    value="1142926459" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="input-fullname" class="form-label">E-mail Institucional</label>
                                <input type="text" class="form-control" id="input-fullname" name="input-fullname"
                                    value="rafael.pfreire1@senacsp.edu.br" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="input-fullname" class="form-label">E-mail Pessoal (opcional)</label>
                                <input type="text" class="form-control" id="input-fullname" name="input-fullname">
                                <div class="form-text">Se estiver com o seu e-mail pessoal cadastrado, receberá todas as
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" disabled>
                                    ...
                                    <option value="comp" selected>Engenharia de Computação</option>
